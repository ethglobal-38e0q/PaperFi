...
const DepthChart = ({ pair }: { pair: string }) => {
  ...
  return (
    <div className="glass p-4 rounded-xl h-full">
      <h3 className="text-sm font-semibold mb-3 text-muted-foreground">DEPTH CHART</h3>
        ...
        <AreaChart data={depthData}>
          <defs>
            ...
            <linearGradient id="askGradient" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="hsl(var(--loss))" stopOpacity={0.6}/>
              <stop offset="95%" stopColor="hsl(var(--loss))" stopOpacity={0.1}/>
            </linearGradient>
          </defs>
          <XAxis 
            dataKey="price" 
